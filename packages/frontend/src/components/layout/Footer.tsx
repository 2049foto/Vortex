        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-neutral-900">Vortex</span>
            </div>
            <p className="text-sm text-neutral-500 mb-4">
              Secure DeFi trading on Base. Protect your portfolio with AI-powered security scanning.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {links.product.map((link) => (
                <li key={link.href}>
                  <Link to={link.href} className="text-sm text-neutral-500 hover:text-neutral-900 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
